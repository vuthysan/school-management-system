...
export const translations = {
	en: {
		...
		configure_foundation:
			"Configure the foundation: academic years, terms, and holidays.",
		...
		start_by_adding_academic_year: "Start by adding your first academic year.",
		...
		start_by_adding_term: "Start by adding a term to this academic year.",
		...
		no_calendar_events: "No calendar events found",
		start_by_adding_event:
			"Start by adding your first school event or holiday.",
		closed: "Closed",
		open: "Open",
		...
		Custom: "Custom",
		add_new: "Add New",
		fill_form_details: "Please fill in the details below.",
	...
	km: {
		...
		// School Setup
		school_setup: "ការកំណត់សាលា",
		configure_foundation:
			"កំណត់មូលដ្ឋានគ្រឹះ៖ ឆ្នាំសិក្សា វគ្គសិក្សា និងថ្ងៃឈប់សម្រាក។",
		academic_years: "ឆ្នាំសិក្សា",
		academic_year_name: "ឈ្មោះឆ្នាំសិក្សា",
		add_academic_year: "បន្ថែមឆ្នាំសិក្សា",
		edit_academic_year: "កែសម្រួលឆ្នាំសិក្សា",
		current_academic_year: "ឆ្នាំសិក្សាបច្ចុប្បន្ន",
		no_academic_years: "រកមិនឃើញឆ្នាំសិក្សាទេ។",
		start_by_adding_academic_year:
			"ចាប់ផ្តើមដោយបន្ថែមឆ្នាំសិក្សាដំបូងរបស់អ្នក។",

		// Terms
		terms: "វគ្គសិក្សា",
		term_name: "ឈ្មោះវគ្គសិក្សា",
		term_number: "លេខរៀងវគ្គ",
		term_type: "ប្រភេទវគ្វ",
		add_term: "បន្ថែមវគ្គសិក្សា",
		edit_term: "កែសម្រួលវគ្គសិក្សា",
		current_term: "វគ្គសិក្សាបច្ចុប្បន្ន",
		no_terms: "រកមិនឃើញវគ្គសិក្សាទេ។",
		start_by_adding_term: "ចាប់ផ្តើមដោយបន្ថែមវគ្គសិក្សាទៅក្នុងឆ្នាំសិក្សានេះ។",
		...
		start_date_time: "ថ្ងៃ និងម៉ោងចាប់ផ្តើម",
		end_date_time: "ថ្ងៃ និងម៉ោងបញ្ចប់",
		all_day_event: "ព្រឹត្តិការណ៍ពេញមួយថ្ងៃ",
		school_closed: "សាលាឈប់សម្រាក",
		display_color: "ពណ៌បង្ហាញ",
		holiday: "ថ្ងៃឈប់សម្រាក",
		exam_period: "សម័យប្រឡង",
		school_event: "ព្រឹត្តិការណ៍សាលា",
		no_calendar_events: "រកមិនឃើញព្រឹត្តិការណ៍ប្រតិទិនទេ",
		start_by_adding_event:
			"ចាប់ផ្តើមដោយបន្ថែមព្រឹត្តិការណ៍សាលា ឬថ្ងៃឈប់សម្រាកដំបូងរបស់អ្នក។",
		closed: "បិទ",
		open: "បើក",
		...
		Custom: "តាមតម្រូវការ",
		add_new: "បន្ថែមថ្មី",
		fill_form_details: "សូមបំពេញព័ត៌មានលម្អិតខាងក្រោម។",
		confirm_delete: "បញ្ជាក់ការលុប",
		delete_item_warning:
			"តើអ្នកប្រាកដថាចង់លុបធាតុនេះមែនទេ? សកម្មភាពនេះមិនអាចត្រឡប់វិញបានទេ។",
