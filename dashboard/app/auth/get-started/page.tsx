      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-lg">
            {user?.name ? `Hello, ${user.name}!` : "Hello!"} We&apos;re excited
            to have you on board. Please provide the necessary information to
            get started.
          </p>
        </div>
          ...
          >
            <Card className="h-full bg-slate-800/50 border-slate-700 hover:border-purple-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/10">
              <CardHeader className="text-center pb-2">
                ...
                <CardDescription className="text-gray-400">
                  I&apos;m a teacher, staff, or parent joining an existing
                  school
                </CardDescription>
              </CardHeader>
              <CardContent className="pt-4">
        ...
        <p className="text-center text-gray-500 text-sm mt-8">
          Already have access?{" "}
          <Link className="text-blue-400 hover:underline" href="/auth">
            Go to Dashboard
          </Link>
        </p>
      </motion.div>
