...
export default function DashboardPage() {
  ...
  const currentRole = "admin"; // Change this to test different roles

  const currentStats = stats[currentRole as keyof typeof stats] || stats.admin;
  const currentActivities =
    recentActivities[currentRole as keyof typeof recentActivities] ||
        ...
        >
          ...
          <div className="h-64 flex items-center justify-center text-gray-400">
            <div className="text-center">
              ...
              <p className="text-sm mt-2">Integration with Chart.js or Recharts coming soon</p>
            </div>
          </div>
        </motion.div>
      </motion.div>
